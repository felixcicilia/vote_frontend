...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_50_Template(rf, ctx) {
  if (rf & 1) {
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 65);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 65);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 65);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(11, "div", 49)(12, "div")(13, "div", 50)(14, "label", 51);
    \u0275\u0275text(15, "Fecha de salida");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "label", 52)(17, "input", 53);
    \u0275\u0275listener("change", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_change_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.form.departureDate = ctx_r1.form.departureDate ? "" : ctx_r1.today);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span", 54);
    \u0275\u0275text(19, "Recurrente (sin fecha)");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "input", 55);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div")(24, "label", 57);
    \u0275\u0275text(25, "Hora de salida ");
    \u0275\u0275elementStart(26, "span", 58);
    \u0275\u0275text(27, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "input", 59);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div")(30, "label", 57);
    \u0275\u0275text(31, "Direcci\xF3n ");
    \u0275\u0275elementStart(32, "span", 58);
    \u0275\u0275text(33, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 60)(35, "label", 61)(36, "input", 62);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_36_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275text(37, " \u2192 Ida ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "label", 61)(39, "input", 63);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_39_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r1.form.direction, $event) || (ctx_r1.form.direction = $event);
      return \u0275\u0275resetView($event);
    ...
    \u0275\u0275text(40, " \u2190 Regreso ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "div")(42, "label", 57);
    \u0275\u0275text(43, "Punto de salida ");
    \u0275\u0275elementStart(44, "span", 58);
    \u0275\u0275text(45, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "select", 64);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_select_ngModelChange_46_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r1.form.departurePointId, $event) || (ctx_r1.form.departurePointId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(47, "option", 65);
    \u0275\u0275text(48, "Seleccionar...");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "optgroup", 66);
    \u0275\u0275template(50, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_50_Template, 2, 4, "option", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "optgroup", 68);
    \u0275\u0275template(52, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_52_Template, 2, 4, "option", 67);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(53, "div")(54, "label", 57);
    \u0275\u0275text(55, "Punto de llegada ");
    \u0275\u0275elementStart(56, "span", 58);
    \u0275\u0275text(57, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(58, "select", 64);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_select_ngModelChange_58_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
      \u0275\u0275twoWayBindingSet(ctx_r1.form.arrivalPointId, $event) || (ctx_r1.form.arrivalPointId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(59, "option", 65);
    \u0275\u0275text(60, "Seleccionar...");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "optgroup", 66);
    \u0275\u0275template(62, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_62_Template, 2, 4, "option", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "optgroup", 68);
    \u0275\u0275template(64, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_option_64_Template, 2, 4, "option", 67);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div")(66, "label", 57);
    \u0275\u0275text(67, "Precio / persona (USD) ");
    \u0275\u0275elementStart(68, "span", 58);
    \u0275\u0275text(69, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(70, "div", 69)(71, "span", 70);
    \u0275\u0275text(72, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "input", 71);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_73_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(74, "div")(75, "label", 57);
    \u0275\u0275text(76, "Duraci\xF3n (min)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "input", 72);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(78, "div")(79, "label", 57);
    \u0275\u0275text(80, "M\xE1x. pasajeros");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "input", 73);
    \u0275\u0275twoWayListener("ngModelChange", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_input_ngModelChange_81_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(82, "div", 74)(83, "button", 75);
    \u0275\u0275listener("click", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_button_click_83_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275text(84);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "button", 76);
    \u0275\u0275listener("click", function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template_button_click_85_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.cancel());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275property("checked", !ctx_r1.form.departureDate);
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.form.departureDate);
    \u0275\u0275property("disabled", !ctx_r1.form.departureDate && ctx_r1.form.departureDate === "")("min", ctx_r1.editingId ? "" : ctx_r1.today);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.form.departureDate ? "Solo disponible esa fecha" : "Aparece todos los d\xEDas (horario fijo)", " ");
    \u0275\u0275advance(6);
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr", 86)(1, "td", 91)(2, "p", 44);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_p_4_Template, 2, 0, "p", 92);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 91)(6, "span", 93);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td", 91)(9, "p", 94);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_p_11_Template, 2, 1, "p", 95);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 96);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 97);
    \u0275\u0275template(15, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_p_15_Template, 3, 4, "p", 98)(16, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_p_16_Template, 2, 0, "p", 99);
    \u0275\u0275elementStart(17, "p", 100);
    \u0275\u0275text(18, "/ persona");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "td", 101);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "td", 102)(22, "span", 93);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "td", 91)(25, "div", 103)(26, "button", 104);
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 78)(2, "div")(3, "h3", 20);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p", 79);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "div", 80)(8, "input", 81);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 82)(10, "span", 31);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "div", 84)(14, "table", 85)(15, "thead")(16, "tr", 86)(17, "th", 87);
    \u0275\u0275text(18, "Hora");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "th", 87);
    \u0275\u0275text(20, "Direcci\xF3n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "th", 87);
    \u0275\u0275text(22, "Ruta");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "th", 87);
    \u0275\u0275text(24, "Fecha");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "th", 88);
    \u0275\u0275text(26, "Precio");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "th", 89);
    \u0275\u0275text(28, "Cupos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "th", 89);
    \u0275\u0275text(30, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "th", 89);
    \u0275\u0275text(32, "Acciones");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "tbody");
    \u0275\u0275template(34, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_34_Template, 32, 44, "tr", 90)(35, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_tr_35_Template, 3, 1, "tr", 2);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(4);
...
function ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_1_Template, 2, 1, "div", 38)(2, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_2_Template, 87, 45, "div", 39)(3, ItinerarioComponent_ng_container_2_ng_container_14_ng_container_12_div_3_Template, 36, 8, "div", 40);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                <div class="flex items-center justify-between mb-1.5">
                  <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Fecha de salida</label>
                  <label class="flex items-center gap-1.5 cursor-pointer">
                    <input type="checkbox"
                      [checked]="!form.departureDate"
                      (change)="form.departureDate = form.departureDate ? '' : today"
                      class="accent-brand-500 w-3.5 h-3.5" />
                    <span class="text-[11px] text-gray-400">Recurrente (sin fecha)</span>
                  </label>
                </div>
                <input type="date" [(ngModel)]="form.departureDate"
                  [disabled]="!form.departureDate && form.departureDate === ''"
                  [min]="editingId ? '' : today"
                  class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 text-sm text-gray-700 outline-none focus:border-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 disabled:opacity-40 disabled:cursor-not-allowed" />
                <p class="mt-1 text-[10px] text-gray-400">
                  {{ form.departureDate ? 'Solo disponible esa fecha' : 'Aparece todos los d\xEDas (horario fijo)' }}
                </p>
              </div>
...
//# sourceMappingURL=chunk-3ZMDDL2H.js.map
