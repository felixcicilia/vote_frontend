...
var _c0 = () => [];
function BuscarComponent_optgroup_23_option_1_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_optgroup_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "optgroup", 38);
    \u0275\u0275template(1, BuscarComponent_optgroup_23_option_1_Template, 2, 3, "option", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function BuscarComponent_optgroup_24_option_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 15);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BuscarComponent_optgroup_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "optgroup", 40);
    \u0275\u0275template(1, BuscarComponent_optgroup_24_option_1_Template, 2, 3, "option", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BuscarComponent_optgroup_35_option_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 15);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BuscarComponent_optgroup_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "optgroup", 40);
    \u0275\u0275template(1, BuscarComponent_optgroup_35_option_1_Template, 2, 3, "option", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BuscarComponent_optgroup_36_option_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 15);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BuscarComponent_optgroup_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "optgroup", 38);
    \u0275\u0275template(1, BuscarComponent_optgroup_36_option_1_Template, 2, 3, "option", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BuscarComponent_div_82_div_7_button_4_ng_container_1_span_9_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_82_div_7_button_4_ng_container_1_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 60);
  }
}
function BuscarComponent_div_82_div_7_button_4_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 51);
    \u0275\u0275element(2, "img", 52)(3, "div", 53);
    \u0275\u0275elementStart(4, "div", 54)(5, "p", 55);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 56);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, BuscarComponent_div_82_div_7_button_4_ng_container_1_span_9_Template, 2, 0, "span", 57)(10, BuscarComponent_div_82_div_7_button_4_ng_container_1_div_10_Template, 1, 0, "div", 58);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function BuscarComponent_div_82_div_7_button_4_ng_template_2_span_7_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_82_div_7_button_4_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 61);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, BuscarComponent_div_82_div_7_button_4_ng_template_2_span_7_Template, 2, 0, "span", 64);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const punto_r7 = \u0275\u0275nextContext().$implicit;
...
function BuscarComponent_div_82_div_7_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function BuscarComponent_div_82_div_7_button_4_Template_button_click_0_listener() {
      const punto_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.elegirDestino(punto_r7));
    });
    \u0275\u0275template(1, BuscarComponent_div_82_div_7_button_4_ng_container_1_Template, 11, 7, "ng-container", 50)(2, BuscarComponent_div_82_div_7_button_4_ng_template_2_Template, 8, 13, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function BuscarComponent_div_82_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 45)(1, "h3", 46);
    \u0275\u0275text(2, "\u{1F3DD}\uFE0F Islas y cayos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 47);
    \u0275\u0275template(4, BuscarComponent_div_82_div_7_button_4_Template, 4, 6, "button", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function BuscarComponent_div_82_div_8_button_4_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 65);
    \u0275\u0275text(1, " \u2713 Destino ");
    \u0275\u0275elementEnd();
...
function BuscarComponent_div_82_div_8_button_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function BuscarComponent_div_82_div_8_button_4_Template_button_click_0_listener() {
      const punto_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.elegirDestino(punto_r10));
    });
    \u0275\u0275elementStart(1, "div", 20)(2, "div", 61);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, BuscarComponent_div_82_div_8_button_4_span_8_Template, 2, 0, "span", 64);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function BuscarComponent_div_82_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "h3", 46);
    \u0275\u0275text(2, "\u2693 Muelles y puertos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 47);
    \u0275\u0275template(4, BuscarComponent_div_82_div_8_button_4_Template, 9, 17, "button", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function BuscarComponent_div_82_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "div", 41)(2, "div")(3, "h2", 42);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, BuscarComponent_div_82_div_7_Template, 5, 1, "div", 44)(8, BuscarComponent_div_82_div_8_Template, 5, 1, "div", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function BuscarComponent_div_83_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 66)(1, "h2", 67);
    \u0275\u0275text(2, "\xBFC\xF3mo funciona?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 68)(4, "div", 69)(5, "div", 70);
    \u0275\u0275text(6, "\u{1F50D}");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 69)(12, "div", 73);
    \u0275\u0275text(13, "\u26F5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "p", 71);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 69)(19, "div", 74);
    \u0275\u0275text(20, "\u{1F389}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "p", 71);
    \u0275\u0275text(22, "3. Reserva y disfruta");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "p", 72);
    \u0275\u0275text(24, "Confirma tu reserva, paga y pres\xE9ntate en el puerto en la hora indicada.");
    \u0275\u0275elementEnd()()()();
  }
}
function BuscarComponent_div_84_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_85_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function BuscarComponent_div_85_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext();
...
function BuscarComponent_div_86_span_5_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_p_6_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_img_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 116);
  }
  if (rf & 2) {
...
function BuscarComponent_div_86_div_9_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_p_13_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_span_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 104);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function BuscarComponent_div_86_div_9_div_21_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 119)(1, "p", 120);
    \u0275\u0275text(2, "\u2192 Salidas");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 121);
    \u0275\u0275template(4, BuscarComponent_div_86_div_9_div_21_span_4_Template, 7, 6, "span", 122);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const g_r14 = \u0275\u0275nextContext().$implicit;
...
function BuscarComponent_div_86_div_9_div_22_span_4_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_div_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 126)(1, "p", 120);
    \u0275\u0275text(2, "\u2190 Regresos");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 121);
    \u0275\u0275template(4, BuscarComponent_div_86_div_9_div_22_span_4_Template, 7, 6, "span", 127);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const g_r14 = \u0275\u0275nextContext().$implicit;
...
function BuscarComponent_div_86_div_9_div_23_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_div_23_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
function BuscarComponent_div_86_div_9_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 131);
    \u0275\u0275template(1, BuscarComponent_div_86_div_9_div_23_span_1_Template, 2, 1, "span", 132)(2, BuscarComponent_div_86_div_9_div_23_span_2_Template, 2, 1, "span", 133);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const g_r14 = \u0275\u0275nextContext().$implicit;
...
function BuscarComponent_div_86_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 91)(1, "div", 92)(2, "div", 93);
    \u0275\u0275template(3, BuscarComponent_div_86_div_9_img_3_Template, 1, 2, "img", 94)(4, BuscarComponent_div_86_div_9_div_4_Template, 2, 1, "div", 95);
    \u0275\u0275element(5, "div", 96);
    \u0275\u0275elementStart(6, "span", 97);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 98)(9, "div", 99)(10, "div", 100)(11, "h3", 101);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, BuscarComponent_div_86_div_9_p_13_Template, 2, 1, "p", 102);
    \u0275\u0275elementStart(14, "div", 103)(15, "span", 104);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275template(17, BuscarComponent_div_86_div_9_span_17_Template, 2, 1, "span", 105)(18, BuscarComponent_div_86_div_9_span_18_Template, 2, 1, "span", 105);
    \u0275\u0275elementStart(19, "span", 106);
    \u0275\u0275text(20, "\u2713 Disponible");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, BuscarComponent_div_86_div_9_div_21_Template, 5, 1, "div", 107)(22, BuscarComponent_div_86_div_9_div_22_Template, 5, 1, "div", 108)(23, BuscarComponent_div_86_div_9_div_23_Template, 3, 3, "div", 109);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 110)(25, "p", 111);
    \u0275\u0275text(26, "desde");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "p", 112);
    \u0275\u0275text(28);
    \u0275\u0275pipe(29, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "p", 111);
    \u0275\u0275text(31, "USD por persona");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "p", 113);
    \u0275\u0275text(33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "p", 114);
    \u0275\u0275text(35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "button", 115);
    \u0275\u0275listener("click", function BuscarComponent_div_86_div_9_Template_button_click_36_listener() {
...
function BuscarComponent_div_86_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 82)(1, "div", 83)(2, "div")(3, "h2", 84);
    \u0275\u0275text(4);
    \u0275\u0275template(5, BuscarComponent_div_86_span_5_Template, 2, 2, "span", 85);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, BuscarComponent_div_86_p_6_Template, 2, 2, "p", 86);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 87);
    \u0275\u0275listener("click", function BuscarComponent_div_86_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext();
      ctx_r1.buscado = false;
      return \u0275\u0275resetView(ctx_r1.vesselGroups = []);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, BuscarComponent_div_86_div_9_Template, 38, 18, "div", 88);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var BuscarComponent = class _BuscarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BuscarComponent, selectors: [["app-buscar"]], decls: 87, vars: 24, consts: [["sinFotoIsla", ""], [1, "space-y-10"], [1, "overflow-hidden", "rounded-2xl", "bg-gradient-to-br", "from-[#0a1628]", "via-[#0d2240]", "to-[#0a3d62]", "shadow-2xl"], [1, "pointer-events-none", "absolute", "inset-0", "overflow-hidden", "opacity-5", "select-none"], [1, "absolute", "-right-10", "-top-10", "text-[280px]", "leading-none"], [1, "relative", "px-6", "py-12", "md:px-12"], [1, "mb-8", "text-center"], [1, "mb-2", "text-xs", "font-bold", "uppercase", "tracking-[0.2em]", "text-blue-400"], [1, "text-4xl", "font-black", "text-white", "md:text-5xl"], [1, "mt-3", "text-base", "text-slate-300"], ["id", "search-form", 1, "mx-auto", "max-w-5xl", "overflow-hidden", "rounded-2xl", "bg-white", "shadow-2xl", "dark:bg-slate-800"], [1, "grid", "grid-cols-1", "divide-y", "divide-gray-100", "dark:divide-slate-700", "sm:grid-cols-2", "sm:divide-x", "sm:divide-y-0", "lg:grid-cols-4"], [1, "group", "p-5", "transition", "hover:bg-blue-50/50", "dark:hover:bg-blue-900/10"], [1, "flex", "items-center", "gap-1.5", "text-[10px]", "font-bold", "uppercase", "tracking-widest", "text-gray-400"], [1, "mt-2", "w-full", "border-0", "bg-transparent", "text-sm", "font-semibold", "text-gray-800", "outline-none", "dark:text-white", "cursor-pointer", 3, "ngModelChange", "ngModel", "disabled"], [3, "ngValue"], ["label", "Muelles", 4, "ngIf"], ["label", "Islas", 4, "ngIf"], [1, "mt-1", "text-xs", "text-gray-400"], [1, "group", "p-5", "transition", "hover:bg-emerald-50/50", "dark:hover:bg-emerald-900/10"], [1, "p-5"], ["type", "date", 1, "mt-2", "w-full", "border-0", "bg-transparent", "text-sm", "font-semibold", "text-gray-800", "outline-none", "dark:text-white", 3, "ngModelChange", "ngModel", "min"], [1, "mt-2", "text-xs", "text-gray-400"], [1, "flex", "flex-col", "justify-between", "p-5"], [1, "mt-2", "flex", "items-center", "gap-4"], ["type", "button", 1, "flex", "h-8", "w-8", "items-center", "justify-center", "rounded-full", "border-2", "border-gray-200", "text-lg", "font-bold", "text-gray-500", "hover:border-blue-400", "hover:text-blue-600", "transition", "dark:border-slate-600", 3, "click"], [1, "text-2xl", "font-black", "text-gray-800", "dark:text-white"], [1, "mt-4", "w-full", "rounded-xl", "bg-brand-500", "py-3", "text-sm", "font-black", "text-white", "shadow-lg", "hover:bg-brand-600", "disabled:opacity-40", "transition-all", "hover:shadow-brand-500/30", "hover:shadow-xl", 3, "click", "disabled"], [1, "mt-6", "flex", "flex-wrap", "justify-center", "gap-6", "text-center"], [1, "text-white/70"], [1, "text-2xl", "font-black", "text-white"], [1, "ml-1", "text-sm"], [1, "text-white/30"], [4, "ngIf"], ["class", "rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]", 4, "ngIf"], ["class", "flex flex-col items-center justify-center py-16 gap-4", 4, "ngIf"], ["class", "rounded-2xl border border-dashed border-gray-300 bg-white p-14 text-center dark:border-gray-700 dark:bg-white/[0.02]", 4, "ngIf"], ["class", "space-y-4", 4, "ngIf"], ["label", "Muelles"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["label", "Islas"], [1, "mb-5", "flex", "items-center", "justify-between"], [1, "text-xl", "font-bold", "text-gray-800", "dark:text-white/90"], [1, "mt-0.5", "text-sm", "text-gray-500"], ["class", "mb-6", 4, "ngIf"], [1, "mb-6"], [1, "mb-3", "text-sm", "font-bold", "uppercase", "tracking-widest", "text-gray-400"], [1, "grid", "grid-cols-2", "gap-4", "sm:grid-cols-3", "lg:grid-cols-4"], ["class", "group relative overflow-hidden rounded-2xl border-2 text-left transition-all hover:shadow-xl", 3, "border-brand-400", "border-transparent", "click", 4, "ngFor", "ngForOf"], [1, "group", "relative", "overflow-hidden", "rounded-2xl", "border-2", "text-left", "transition-all", "hover:shadow-xl", 3, "click"], [4, "ngIf", "ngIfElse"], [1, "relative", "h-36", "w-full", "sm:h-44"], [1, "h-full", "w-full", "object-cover", "transition-transform", "duration-500", "group-hover:scale-105", 3, "src", "alt"], [1, "absolute", "inset-0", "bg-gradient-to-t", "from-black/70", "via-black/20", "to-transparent"], [1, "absolute", "bottom-0", "left-0", "right-0", "p-3"], [1, "text-sm", "font-bold", "text-white", "leading-tight"], [1, "text-[10px]", "text-white/70"], ["class", "absolute right-2 top-2 rounded-full bg-brand-500 px-2 py-0.5 text-[10px] font-bold text-white shadow", 4, "ngIf"], ["class", "absolute inset-0 ring-2 ring-inset ring-brand-400 rounded-2xl", 4, "ngIf"], [1, "absolute", "right-2", "top-2", "rounded-full", "bg-brand-500", "px-2", "py-0.5", "text-[10px]", "font-bold", "text-white", "shadow"], [1, "absolute", "inset-0", "ring-2", "ring-inset", "ring-brand-400", "rounded-2xl"], [1, "mb-3", "text-4xl"], [1, "font-bold", "text-gray-800", "dark:text-white/90", "group-hover:text-brand-600", "transition-colors"], [1, "mt-0.5", "text-xs", "text-gray-400"], ["class", "absolute right-2 top-2 rounded-full bg-brand-500 px-2 py-0.5 text-[10px] font-bold text-white", 4, "ngIf"], [1, "absolute", "right-2", "top-2", "rounded-full", "bg-brand-500", "px-2", "py-0.5", "text-[10px]", "font-bold", "text-white"], [1, "rounded-2xl", "border", "border-gray-200", "bg-white", "p-8", "shadow-sm", "dark:border-gray-800", "dark:bg-white/[0.03]"], [1, "mb-8", "text-center", "text-xl", "font-bold", "text-gray-800", "dark:text-white/90"], [1, "grid", "grid-cols-1", "gap-8", "sm:grid-cols-3"], [1, "text-center"], [1, "mx-auto", "mb-4", "flex", "h-16", "w-16", "items-center", "justify-center", "rounded-2xl", "bg-blue-100", "text-3xl", "dark:bg-blue-500/15"], [1, "font-bold", "text-gray-700", "dark:text-gray-300"], [1, "mt-2", "text-sm", "text-gray-500"], [1, "mx-auto", "mb-4", "flex", "h-16", "w-16", "items-center", "justify-center", "rounded-2xl", "bg-emerald-100", "text-3xl", "dark:bg-emerald-500/15"], [1, "mx-auto", "mb-4", "flex", "h-16", "w-16", "items-center", "justify-center", "rounded-2xl", "bg-amber-100", "text-3xl", "dark:bg-amber-500/15"], [1, "flex", "flex-col", "items-center", "justify-center", "py-16", "gap-4"], [1, "text-5xl", "animate-bounce"], [1, "text-gray-500", "dark:text-gray-400", "font-medium"], [1, "rounded-2xl", "border", "border-dashed", "border-gray-300", "bg-white", "p-14", "text-center", "dark:border-gray-700", "dark:bg-white/[0.02]"], [1, "text-5xl", "mb-4"], [1, "text-lg", "font-bold", "text-gray-700", "dark:text-white/80"], [1, "mt-5", "rounded-xl", "border", "border-gray-300", "px-6", "py-2.5", "text-sm", "font-semibold", "text-gray-600", "hover:bg-gray-50", "dark:border-gray-700", "dark:text-gray-400", 3, "click"], [1, "space-y-4"], [1, "flex", "items-center", "justify-between"], [1, "text-lg", "font-bold", "text-gray-800", "dark:text-white/90"], ["class", "text-brand-600 dark:text-brand-400", 4, "ngIf"], ["class", "text-sm text-gray-400", 4, "ngIf"], [1, "rounded-lg", "border", "border-gray-200", "px-3", "py-1.5", "text-xs", "font-medium", "text-gray-500", "hover:bg-gray-50", "dark:border-gray-700", "dark:text-gray-400", 3, "click"], ["class", "group overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm hover:shadow-xl hover:border-brand-200 transition-all duration-300 dark:border-gray-800 dark:bg-white/[0.03] dark:hover:border-brand-500/30", 4, "ngFor", "ngForOf"], [1, "text-brand-600", "dark:text-brand-400"], [1, "text-sm", "text-gray-400"], [1, "group", "overflow-hidden", "rounded-2xl", "border", "border-gray-200", "bg-white", "shadow-sm", "hover:shadow-xl", "hover:border-brand-200", "transition-all", "duration-300", "dark:border-gray-800", "dark:bg-white/[0.03]", "dark:hover:border-brand-500/30"], [1, "flex", "flex-col", "md:flex-row"], [1, "relative", "h-56", "w-full", "flex-shrink-0", "overflow-hidden", "bg-gradient-to-br", "from-blue-900", "to-slate-900", "md:h-auto", "md:w-72"], ["class", "h-full w-full object-cover group-hover:scale-105 transition-transform duration-500", 3, "src", "alt", 4, "ngIf"], ["class", "flex h-full items-center justify-center text-8xl opacity-20", 4, "ngIf"], [1, "absolute", "inset-0", "bg-gradient-to-t", "from-black/40", "to-transparent"], [1, "absolute", "bottom-3", "left-3", "rounded-full", "bg-white/95", "px-3", "py-1", "text-xs", "font-black", "text-slate-800", "shadow-sm"], [1, "flex", "flex-1", "flex-col", "p-6"], [1, "flex", "flex-col", "gap-5", "lg:flex-row", "lg:items-start", "lg:justify-between"], [1, "flex-1", "min-w-0"], [1, "text-xl", "font-black", "text-gray-800", "dark:text-white/90"], ["class", "text-xs font-medium text-gray-400", 4, "ngIf"], [1, "mt-2", "flex", "flex-wrap", "gap-3", "text-sm", "text-gray-500", "dark:text-gray-400"], [1, "flex", "items-center", "gap-1"], ["class", "flex items-center gap-1", 4, "ngIf"], [1, "flex", "items-center", "gap-1", "font-semibold", "text-green-600", "dark:text-green-400"], ["class", "mt-4", 4, "ngIf"], ["class", "mt-3", 4, "ngIf"], ["class", "mt-4 flex flex-wrap gap-1.5", 4, "ngIf"], [1, "flex-shrink-0", "rounded-2xl", "border", "border-gray-100", "bg-gray-50", "p-5", "text-center", "dark:border-gray-800", "dark:bg-white/[0.03]", "lg:min-w-[180px]"], [1, "text-xs", "text-gray-400"], [1, "mt-1", "text-4xl", "font-black", "text-brand-600", "dark:text-brand-400"], [1, "mt-1", "text-sm", "font-bold", "text-brand-500"], [1, "text-[10px]", "text-gray-400"], [1, "mt-4", "w-full", "rounded-xl", "bg-brand-500", "px-5", "py-3", "text-sm", "font-black", "text-white", "shadow-md", "hover:bg-brand-600", "transition-all", "hover:shadow-brand-500/30", "hover:shadow-lg", 3, "click"], [1, "h-full", "w-full", "object-cover", "group-hover:scale-105", "transition-transform", "duration-500", 3, "src", "alt"], [1, "flex", "h-full", "items-center", "justify-center", "text-8xl", "opacity-20"], [1, "text-xs", "font-medium", "text-gray-400"], [1, "mt-4"], [1, "mb-2", "text-[11px]", "font-black", "uppercase", "tracking-widest", "text-gray-400"], [1, "flex", "flex-wrap", "gap-2"], ["class", "flex items-center gap-1.5 rounded-xl border border-blue-200 bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-800 dark:border-blue-700/30 dark:bg-blue-500/10 dark:text-blue-300", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "gap-1.5", "rounded-xl", "border", "border-blue-200", "bg-blue-50", "px-3", "py-1.5", "text-xs", "font-bold", "text-blue-800", "dark:border-blue-700/30", "dark:bg-blue-500/10", "dark:text-blue-300"], [1, "text-blue-400"], [1, "ml-1", "rounded-full", "bg-blue-600", "px-2", "py-0.5", "text-[10px]", "text-white"], [1, "mt-3"], ["class", "flex items-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-xs font-bold text-emerald-800 dark:border-emerald-700/30 dark:bg-emerald-500/10 dark:text-emerald-300", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "gap-1.5", "rounded-xl", "border", "border-emerald-200", "bg-emerald-50", "px-3", "py-1.5", "text-xs", "font-bold", "text-emerald-800", "dark:border-emerald-700/30", "dark:bg-emerald-500/10", "dark:text-emerald-300"], [1, "text-emerald-500"], [1, "ml-1", "rounded-full", "bg-emerald-600", "px-2", "py-0.5", "text-[10px]", "text-white"], [1, "mt-4", "flex", "flex-wrap", "gap-1.5"], ["class", "rounded-full bg-gray-100 px-2.5 py-1 text-xs text-gray-500 dark:bg-white/[0.06] dark:text-gray-400", 4, "ngFor", "ngForOf"], ["class", "rounded-full bg-gray-100 px-2.5 py-1 text-xs text-gray-400 dark:bg-white/[0.06]", 4, "ngIf"], [1, "rounded-full", "bg-gray-100", "px-2.5", "py-1", "text-xs", "text-gray-500", "dark:bg-white/[0.06]", "dark:text-gray-400"], [1, "rounded-full", "bg-gray-100", "px-2.5", "py-1", "text-xs", "text-gray-400", "dark:bg-white/[0.06]"]], template: function BuscarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, BuscarComponent_optgroup_23_Template, 2, 1, "optgroup", 16)(24, BuscarComponent_optgroup_24_Template, 2, 1, "optgroup", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "p", 18);
      \u0275\u0275text(26);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(27, "div", 19)(28, "label", 13)(29, "span");
      \u0275\u0275text(30, "\u{1F3DD}\uFE0F");
      \u0275\u0275elementEnd();
      \u0275\u0275text(31, " Llega a ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "select", 14);
      \u0275\u0275twoWayListener("ngModelChange", function BuscarComponent_Template_select_ngModelChange_32_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.llegadaId, $event) || (ctx.llegadaId = $event);
        return $event;
      });
      \u0275\u0275elementStart(33, "option", 15);
      \u0275\u0275text(34, "Cualquier destino");
      \u0275\u0275elementEnd();
      \u0275\u0275template(35, BuscarComponent_optgroup_35_Template, 2, 1, "optgroup", 17)(36, BuscarComponent_optgroup_36_Template, 2, 1, "optgroup", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "p", 18);
      \u0275\u0275text(38);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(39, "div", 20)(40, "label", 13)(41, "span");
      \u0275\u0275text(42, "\u{1F4C5}");
      \u0275\u0275elementEnd();
      \u0275\u0275text(43, " Fecha del viaje ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "input", 21);
      \u0275\u0275twoWayListener("ngModelChange", function BuscarComponent_Template_input_ngModelChange_44_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.fecha, $event) || (ctx.fecha = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(45, "p", 22);
      \u0275\u0275text(46, "Selecciona cu\xE1ndo viajas");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(47, "div", 23)(48, "div")(49, "label", 13)(50, "span");
      \u0275\u0275text(51, "\u{1F465}");
      \u0275\u0275elementEnd();
      \u0275\u0275text(52, " Pasajeros ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "div", 24)(54, "button", 25);
      \u0275\u0275listener("click", function BuscarComponent_Template_button_click_54_listener() {
      ...
      \u0275\u0275listener("click", function BuscarComponent_Template_button_click_60_listener() {
        return ctx.buscar();
      });
      \u0275\u0275text(61);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(62, "div", 28)(63, "div", 29)(64, "span", 30);
      \u0275\u0275text(65);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(76, "|");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(77, "div", 29)(78, "span", 30);
      \u0275\u0275text(79, "100%");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(80, "span", 31);
      \u0275\u0275text(81, "verificadas");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(82, BuscarComponent_div_82_Template, 9, 2, "div", 33)(83, BuscarComponent_div_83_Template, 25, 0, "div", 34)(84, BuscarComponent_div_84_Template, 5, 0, "div", 35)(85, BuscarComponent_div_85_Template, 9, 0, "div", 36)(86, BuscarComponent_div_86_Template, 10, 6, "div", 37);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(20);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.muelles.length);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.islasPuntos.length);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", ctx.salidaSel ? ctx.salidaSel.city + ", " + ctx.salidaSel.state : "Muelle o isla de embarque", " ");
      \u0275\u0275advance(6);
      ...
      \u0275\u0275property("ngIf", ctx.muelles.length);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1(" ", ctx.llegadaSel ? ctx.llegadaSel.city + ", " + ctx.llegadaSel.state : "Muelle o isla destino", " ");
      \u0275\u0275advance(6);
        ...
        <div class="grid grid-cols-1 divide-y divide-gray-100 dark:divide-slate-700 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
          ...
          <div class="group p-5 transition hover:bg-blue-50/50 dark:hover:bg-blue-900/10">
            ...
            <select [(ngModel)]="salidaId" [disabled]="loadingPuntos"
              ...
              <optgroup *ngIf="muelles.length" label="Muelles">
                <option *ngFor="let p of muelles" [ngValue]="p.id">{{ puntoIcon(p) }} {{ p.name }}</option>
              </optgroup>
              <optgroup *ngIf="islasPuntos.length" label="Islas">
                <option *ngFor="let p of islasPuntos" [ngValue]="p.id">{{ puntoIcon(p) }} {{ p.name }}</option>
              </optgroup>
            </select>
            <p class="mt-1 text-xs text-gray-400">
              {{ salidaSel ? salidaSel.city + ', ' + salidaSel.state : 'Muelle o isla de embarque' }}
            </p>
          </div>
          ...
          <div class="group p-5 transition hover:bg-emerald-50/50 dark:hover:bg-emerald-900/10">
            ...
            <p class="mt-1 text-xs text-gray-400">
              {{ llegadaSel ? llegadaSel.city + ', ' + llegadaSel.state : 'Muelle o isla destino' }}
            </p>
          </div>
...
//# sourceMappingURL=chunk-DAUS7IAZ.js.map
