...
// src/app/pages/mi-charter/pages/calendario/calendario.component.ts
function CalendarioComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "div", 14)(2, "div", 15);
    \u0275\u0275text(3, "\u{1F4C5}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 16);
    \u0275\u0275text(5, "Cargando actividad...");
    \u0275\u0275elementEnd()()();
  }
}
function CalendarioComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275element(1, "full-calendar", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("options", ctx_r0.calendarOptions());
  }
}
function CalendarioComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19)(1, "div", 20);
    \u0275\u0275listener("click", function CalendarioComponent_div_20_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closePopup());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 21)(3, "button", 22);
    \u0275\u0275listener("click", function CalendarioComponent_div_20_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closePopup());
    });
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 31)(18, "div", 32)(19, "span", 28);
    \u0275\u0275text(20, "Embarcaci\xF3n");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "span", 33);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 32)(24, "span", 28);
    \u0275\u0275text(25, "Cliente");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "span", 33);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 32)(29, "span", 28);
    \u0275\u0275text(30, "Estado");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 34);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(33, "div", 35)(34, "button", 36);
    \u0275\u0275listener("click", function CalendarioComponent_div_20_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closePopup());
    });
    ...
    \u0275\u0275listener("click", function CalendarioComponent_div_20_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.navigateTo(ctx_r0.popup().route));
    });
    \u0275\u0275text(37, " Ver detalle \u2192 ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275property("ngClass", ctx_r0.typeDotClass(ctx_r0.popup().type));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.typeLabel(ctx_r0.popup().type), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind4(12, 9, ctx_r0.popup().date, "EEEE d MMM yyyy", "", "es"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.popup().title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.popup().subtitle);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("\u26F5 ", ctx_r0.popup().vessel);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("\u{1F464} ", ctx_r0.popup().client);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ctx_r0.popup().statusClass);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.statusLabel(ctx_r0.popup().status), " ");
  }
}
var CalendarioComponent = class _CalendarioComponent {
  ...
  loading = true;
  popup = signal(null, ...ngDevMode ? [{ debugName: "popup" }] : (
  ...
  calendarOptions = signal({
    ...
    eventClassNames: ({ event }) => {
      const cat = event.extendedProps["calendar"];
  ...
  ngOnInit() {
    ...
    forkJoin({
      ...
      next: ({ charters, bookings }) => {
        ...
        this.calendarOptions.update((opts) => __spreadProps(__spreadValues({}, opts), { events }));
        this.loading = false;
      },
      error: () => {
        this.loading = false;
  ...
  chartersToEvents(charters) {
    const events = [];
    for (const c3 of charters) {
      if (c3.status === "CANCELLED")
        continue;
      const name = `${c3.client?.firstName} ${c3.client?.lastName}`;
      events.push({
        id: `charter-start-${c3.id}`,
        title: `\u2693 ${c3.vessel?.name ?? "Charter"}`,
        start: c3.startDate,
        extendedProps: {
          calendar: "primary",
          type: "charter-start",
          subtitle: `Inicio charter \xB7 ${c3.days}n \xB7 ${c3.passengers} pax`,
          vessel: c3.vessel?.name ?? "\u2014",
          client: name,
          status: c3.status,
          route: `/alquileres/${c3.id}`,
          date: c3.startDate
        }
      });
      events.push({
        id: `charter-end-${c3.id}`,
        title: `\u{1F3C1} ${c3.vessel?.name ?? "Charter"}`,
        start: c3.endDate,
        extendedProps: {
          calendar: "success",
          type: "charter-end",
          subtitle: `Fin charter \xB7 ${c3.days}n \xB7 ${c3.passengers} pax`,
          vessel: c3.vessel?.name ?? "\u2014",
          client: name,
          status: c3.status,
          route: `/alquileres/${c3.id}`,
  ...
  bookingsToEvents(bookings) {
    return bookings.filter((b3) => b3.status !== "CANCELLED").map((b3) => ({
      id: `island-${b3.id}`,
      title: `\u{1F6A2} ${b3.vessel?.name ?? "Excursi\xF3n"}`,
      start: b3.tripDate + (b3.outboundSlot?.departureTime ? `T${b3.outboundSlot.departureTime}` : ""),
      extendedProps: {
        calendar: "warning",
        type: "island",
        subtitle: `${b3.departurePoint?.name} \u2192 ${b3.destination?.name}`,
        vessel: b3.vessel?.name ?? "\u2014",
        client: `${b3.client?.firstName} ${b3.client?.lastName}`,
        status: b3.status,
        route: `/reservas-isla/${b3.id}`,
        date: b3.tripDate
      }
    }));
  }
  onEventClick(info) {
    ...
    const p3 = info.event.extendedProps;
    this.popup.set({
      ...
      client: p3["client"],
      status: p3["status"],
      statusClass: this.statusClass(p3["status"]),
      route: p3["route"],
      type: p3["type"],
      date: p3["date"]
    });
  ...
  statusLabel(s3) {
    return { PENDING: "Pendiente", CONFIRMED: "Confirmado", ACTIVE: "Activo", COMPLETED: "Completado", CANCELLED: "Cancelado" }[s3] ?? s3;
  }
  statusClass(s3) {
    return {
  ...
  typeLabel(t3) {
    return { "charter-start": "Inicio de charter", "charter-end": "Fin de charter", "island": "Excursi\xF3n isla" }[t3] ?? t3;
  }
  typeDotClass(t3) {
    return { "charter-start": "bg-brand-500", "charter-end": "bg-green-500", "island": "bg-orange-400" }[t3] ?? "";
  }
  static \u0275fac = function CalendarioComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CalendarioComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CalendarioComponent, selectors: [["app-calendario"]], decls: 21, vars: 3, consts: [[1, "space-y-5"], [1, "rounded-2xl", "border", "border-gray-200", "bg-white", "p-5", "shadow-sm", "dark:border-gray-800", "dark:bg-white/[0.03]"], [1, "flex", "flex-col", "gap-3", "sm:flex-row", "sm:items-center", "sm:justify-between"], [1, "text-2xl", "font-bold", "text-gray-800", "dark:text-white/90"], [1, "mt-1", "text-sm", "text-gray-500", "dark:text-gray-400"], [1, "flex", "flex-wrap", "items-center", "gap-4", "text-xs", "font-medium", "text-gray-600", "dark:text-gray-400"], [1, "flex", "items-center", "gap-1.5"], [1, "inline-block", "h-2.5", "w-2.5", "rounded-sm", "bg-brand-500"], [1, "inline-block", "h-2.5", "w-2.5", "rounded-sm", "bg-green-500"], [1, "inline-block", "h-2.5", "w-2.5", "rounded-sm", "bg-orange-400"], ["class", "flex items-center justify-center py-24", 4, "ngIf"], ["class", "overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]", 4, "ngIf"], ["class", "fixed inset-0 z-[99999] flex items-center justify-center p-4", 4, "ngIf"], [1, "flex", "items-center", "justify-center", "py-24"], [1, "flex", "flex-col", "items-center", "gap-4"], [1, "text-5xl", "animate-bounce"], [1, "text-sm", "text-gray-400"], [1, "overflow-hidden", "rounded-2xl", "border", "border-gray-200", "bg-white", "shadow-sm", "dark:border-gray-800", "dark:bg-white/[0.03]"], [3, "options"], [1, "fixed", "inset-0", "z-[99999]", "flex", "items-center", "justify-center", "p-4"], [1, "absolute", "inset-0", "bg-gray-400/50", "backdrop-blur-sm", 3, "click"], [1, "relative", "z-10", "w-full", "max-w-md", "rounded-3xl", "bg-white", "p-6", "shadow-2xl", "dark:bg-gray-900"], [1, "absolute", "right-4", "top-4", "flex", "h-9", "w-9", "items-center", "justify-center", "rounded-full", "bg-gray-100", "text-gray-400", "hover:bg-gray-200", "hover:text-gray-600", "dark:bg-white/[0.07]", "dark:text-gray-300", "dark:hover:bg-white/[0.12]", 3, "click"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["fill-rule", "evenodd", "clip-rule", "evenodd", "d", "M6.04289 16.5418C5.65237 16.9323 5.65237 17.5655 6.04289 17.956C6.43342 18.3465 7.06658 18.3465 7.45711 17.956L11.9987 13.4144L16.5408 17.9565C16.9313 18.347 17.5645 18.347 17.955 17.9565C18.3455 17.566 18.3455 16.9328 17.955 16.5423L13.4129 12.0002L17.955 7.45808C18.3455 7.06756 18.3455 6.43439 17.955 6.04387C17.5645 5.65335 16.9313 5.65335 16.5408 6.04387L11.9987 10.586L7.45711 6.04439C7.06658 5.65386 6.43342 5.65386 6.04289 6.04439C5.65237 6.43491 5.65237 7.06808 6.04289 7.4586L10.5845 12.0002L6.04289 16.5418Z", "fill", "currentColor"], [1, "flex", "items-center", "gap-2", "mb-4"], [1, "inline-flex", "items-center", "gap-1.5", "rounded-full", "bg-gray-100", "px-3", "py-1", "text-xs", "font-semibold", "text-gray-600", "dark:bg-white/[0.08]", "dark:text-gray-300"], [1, "h-2", "w-2", "rounded-full", 3, "ngClass"], [1, "text-xs", "text-gray-400"], [1, "mb-1", "text-xl", "font-bold", "text-gray-800", "dark:text-white/90"], [1, "mb-5", "text-sm", "text-gray-500", "dark:text-gray-400"], [1, "space-y-3", "rounded-2xl", "bg-gray-50", "p-4", "dark:bg-white/[0.03]"], [1, "flex", "items-center", "justify-between"], [1, "text-sm", "font-medium", "text-gray-800", "dark:text-white/90"], [1, "inline-flex", "rounded-full", "px-2.5", "py-1", "text-xs", "font-semibold", 3, "ngClass"], [1, "mt-5", "flex", "gap-3"], [1, "flex-1", "rounded-xl", "border", "border-gray-200", "py-2.5", "text-sm", "font-medium", "text-gray-600", "hover:bg-gray-50", "dark:border-gray-700", "dark:text-gray-400", "dark:hover:bg-white/[0.04]", 3, "click"], [1, "flex-1", "rounded-xl", "bg-brand-500", "py-2.5", "text-sm", "font-bold", "text-white", "hover:bg-brand-600", "transition-colors", 3, "click"]], template: function CalendarioComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div")(4, "h1", 3);
      \u0275\u0275text(5, "Calendario de actividad");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "p", 4);
      \u0275\u0275text(7, " Charters e excursiones de tus embarcaciones en un solo lugar. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "div", 5)(9, "span", 6);
      \u0275\u0275element(10, "span", 7);
      \u0275\u0275text(11, " Inicio charter ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "span", 6);
      \u0275\u0275element(13, "span", 8);
      \u0275\u0275text(14, " Fin charter ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "span", 6);
      \u0275\u0275element(16, "span", 9);
      \u0275\u0275text(17, " Excursi\xF3n isla ");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(18, CalendarioComponent_div_18_Template, 6, 0, "div", 10)(19, CalendarioComponent_div_19_Template, 2, 1, "div", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275template(20, CalendarioComponent_div_20_Template, 38, 14, "div", 12);
    }
    if (rf & 2) {
      \u0275\u0275advance(18);
      ...
      \u0275\u0275property("ngIf", !ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.popup());
    }
  }, dependencies: [CommonModule, NgClass, NgIf, FullCalendarModule, FullCalendarComponent, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CalendarioComponent, [{
    type: Component,
    args: [{ selector: "app-calendario", standalone: true, imports: [CommonModule, FullCalendarModule], template: `<div class="space-y-5">

  <!-- Header -->
  <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Calendario de actividad</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Charters e excursiones de tus embarcaciones en un solo lugar.
        </p>
      </div>
      <!-- Leyenda -->
      <div class="flex flex-wrap items-center gap-4 text-xs font-medium text-gray-600 dark:text-gray-400">
        <span class="flex items-center gap-1.5">
          <span class="inline-block h-2.5 w-2.5 rounded-sm bg-brand-500"></span> Inicio charter
        </span>
        <span class="flex items-center gap-1.5">
          <span class="inline-block h-2.5 w-2.5 rounded-sm bg-green-500"></span> Fin charter
        </span>
        <span class="flex items-center gap-1.5">
          <span class="inline-block h-2.5 w-2.5 rounded-sm bg-orange-400"></span> Excursi\xF3n isla
        </span>
      </div>
    </div>
  </div>
  ...
  <div *ngIf="loading" class="flex items-center justify-center py-24">
    <div class="flex flex-col items-center gap-4">
      <div class="text-5xl animate-bounce">\u{1F4C5}</div>
      <p class="text-sm text-gray-400">Cargando actividad...</p>
    </div>
  </div>
...
<!-- \u2500\u2500\u2500 Event popup modal \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
<div *ngIf="popup()" class="fixed inset-0 z-[99999] flex items-center justify-center p-4">
  <!-- Backdrop -->
  <div class="absolute inset-0 bg-gray-400/50 backdrop-blur-sm" (click)="closePopup()"></div>
  ...
  <div class="relative z-10 w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl dark:bg-gray-900">
    ...
    <button (click)="closePopup()"
      class="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-white/[0.07] dark:text-gray-300 dark:hover:bg-white/[0.12]">
    ...
    <div class="flex items-center gap-2 mb-4">
      <span class="inline-flex items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-600 dark:bg-white/[0.08] dark:text-gray-300">
        <span class="h-2 w-2 rounded-full" [ngClass]="typeDotClass(popup()!.type)"></span>
        {{ typeLabel(popup()!.type) }}
      </span>
      <span class="text-xs text-gray-400">{{ popup()!.date | date:'EEEE d MMM yyyy':'':'es' }}</span>
    </div>

    <!-- Title -->
    <h3 class="mb-1 text-xl font-bold text-gray-800 dark:text-white/90">{{ popup()!.title }}</h3>
    <p class="mb-5 text-sm text-gray-500 dark:text-gray-400">{{ popup()!.subtitle }}</p>

    <!-- Info rows -->
    <div class="space-y-3 rounded-2xl bg-gray-50 p-4 dark:bg-white/[0.03]">
      <div class="flex items-center justify-between">
        <span class="text-xs text-gray-400">Embarcaci\xF3n</span>
        <span class="text-sm font-medium text-gray-800 dark:text-white/90">\u26F5 {{ popup()!.vessel }}</span>
      </div>
      <div class="flex items-center justify-between">
        <span class="text-xs text-gray-400">Cliente</span>
        <span class="text-sm font-medium text-gray-800 dark:text-white/90">\u{1F464} {{ popup()!.client }}</span>
      </div>
      <div class="flex items-center justify-between">
        <span class="text-xs text-gray-400">Estado</span>
        <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-semibold" [ngClass]="popup()!.statusClass">
    ...
    <div class="mt-5 flex gap-3">
      ...
      <button (click)="navigateTo(popup()!.route)"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CalendarioComponent, { className: "CalendarioComponent", filePath: "src/app/pages/mi-charter/pages/calendario/calendario.component.ts", lineNumber: 37 });
})();
export {
  CalendarioComponent
};
//# sourceMappingURL=chunk-MZQN3XDL.js.map
