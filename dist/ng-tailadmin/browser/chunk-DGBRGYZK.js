...
function DetalleLanchaComponent_ng_container_2_div_43_button_6_div_15_Template(rf, ctx) {
  if (rf & 1) {
...
function DetalleLanchaComponent_ng_container_2_div_43_button_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DetalleLanchaComponent_ng_container_2_div_43_button_6_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.selectIda(s_r10));
    });
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 90)(10, "p", 91);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14, "/ persona");
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, DetalleLanchaComponent_ng_container_2_div_43_button_6_div_15_Template, 2, 0, "div", 92);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r10 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("border-brand-500", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) === s_r10.id)("bg-brand-50", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) === s_r10.id)("dark:bg-brand-500/10", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) === s_r10.id)("border-gray-200", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) !== s_r10.id)("hover:border-brand-300", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) !== s_r10.id)("dark:border-gray-700", (ctx_r1.selectedIda == null ? null : ctx_r1.selectedIda.id) !== s_r10.id);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u{1F465} ", s_r10.maxPassengers ?? ctx_r1.vessel.capacity, " cupos disponibles");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("$", \u0275\u0275pipeBind2(12, 21, s_r10.pricePerPerson, "1.2-2"));
    \u0275\u0275advance(4);
...
function DetalleLanchaComponent_ng_container_2_div_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(6, DetalleLanchaComponent_ng_container_2_div_43_button_6_Template, 16, 24, "button", 84);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DetalleLanchaComponent_ng_container_2_div_44_button_6_div_15_Template(rf, ctx) {
  if (rf & 1) {
...
function DetalleLanchaComponent_ng_container_2_div_44_button_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DetalleLanchaComponent_ng_container_2_div_44_button_6_Template_button_click_0_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.selectRegreso(s_r12));
    });
    \u0275\u0275elementStart(1, "div")(2, "p", 86);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 90)(10, "p", 95);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "p", 32);
    \u0275\u0275text(14, "/ persona");
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, DetalleLanchaComponent_ng_container_2_div_44_button_6_div_15_Template, 2, 0, "div", 96);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r12 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("border-emerald-500", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) === s_r12.id)("bg-emerald-50", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) === s_r12.id)("dark:bg-emerald-500/10", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) === s_r12.id)("border-gray-200", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) !== s_r12.id)("hover:border-emerald-300", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) !== s_r12.id)("dark:border-gray-700", (ctx_r1.selectedRegreso == null ? null : ctx_r1.selectedRegreso.id) !== s_r12.id);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u{1F465} ", s_r12.maxPassengers ?? ctx_r1.vessel.capacity, " cupos disponibles");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("$", \u0275\u0275pipeBind2(12, 21, s_r12.pricePerPerson, "1.2-2"));
    \u0275\u0275advance(4);
...
function DetalleLanchaComponent_ng_container_2_div_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 83);
    \u0275\u0275template(6, DetalleLanchaComponent_ng_container_2_div_44_button_6_Template, 16, 24, "button", 94);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function DetalleLanchaComponent_ng_container_2_div_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 103)(1, "div")(2, "p", 104);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function DetalleLanchaComponent_ng_container_2_div_81_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52)(1, "div", 103)(2, "span", 108);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function DetalleLanchaComponent_ng_container_2_div_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, DetalleLanchaComponent_ng_container_2_div_88_p_1_Template, 2, 0, "p", 112)(2, DetalleLanchaComponent_ng_container_2_div_88_p_2_Template, 2, 0, "p", 112);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
      ...
      <div class="flex-1 min-w-0 space-y-5">
        ...
        <div *ngIf="visibleIdaSlots.length > 0" class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <button *ngFor="let s of visibleIdaSlots" type="button" (click)="selectIda(s)"
              ...
              [class.border-gray-200]="selectedIda?.id !== s.id"
              [class.hover:border-brand-300]="selectedIda?.id !== s.id"
              ...
              <div>
                ...
                <p class="mt-0.5 text-[10px] text-gray-400">\u{1F465} {{ s.maxPassengers ?? vessel!.capacity }} cupos disponibles</p>
              </div>
        ...
        <div *ngIf="visibleRegresoSlots.length > 0" class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <button *ngFor="let s of visibleRegresoSlots" type="button" (click)="selectRegreso(s)"
              class="flex items-center justify-between rounded-2xl border-2 p-4 text-left transition-all"
              ...
              [class.border-gray-200]="selectedRegreso?.id !== s.id"
              [class.hover:border-emerald-300]="selectedRegreso?.id !== s.id"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DetalleLanchaComponent, { className: "DetalleLanchaComponent", filePath: "src/app/pages/buscar/pages/detalle-lancha/detalle-lancha.component.ts", lineNumber: 21 });
})();
export {
  DetalleLanchaComponent
};
//# sourceMappingURL=chunk-DGBRGYZK.js.map
