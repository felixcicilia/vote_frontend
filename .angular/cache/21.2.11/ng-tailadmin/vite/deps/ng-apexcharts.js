...
var ChartComponent = class _ChartComponent {
  ...
  importApexCharts() {
    return import("./apexcharts.esm-IVU5NZIY.js");
  }
  createElement() {
...
var ChartCoreComponent = class _ChartCoreComponent extends ChartComponent {
  importApexCharts() {
    return import("./core.esm-66TEHFI3.js");
  }
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
...
var ChartSSRService = class _ChartSSRService {
  ...
  importSSRModule() {
    return import("./apexcharts.ssr.esm-HEHPHVZM.js");
  }
  renderToHTML(_0) {
